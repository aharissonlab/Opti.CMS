...
{
    readonly MvcContentRenderer _mvcRenderer = mvcRenderer;
    ...
    static void HandlerError(IHtmlHelper helper, IContentData contentData, Exception renderingException)
    {

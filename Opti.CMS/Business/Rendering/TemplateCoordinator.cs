...
public class TemplateCoordinator : IViewTemplateModelRegistrator
{
    ...
    static string BlockPath(string fileName) => $"{BlockFolder}{fileName}";

    static string PagePartialPath(string fileName) => $"{PagePartialsFolder}{fileName}";
}
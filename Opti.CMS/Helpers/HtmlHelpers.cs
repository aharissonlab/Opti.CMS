...
public static class HtmlHelpers
{
    ...
    static MenuItem CreateMenuItem(PageData page, ContentReference currentContentLink, List<ContentReference> pagePath, IContentLoader contentLoader, Func<IEnumerable<PageData>, IEnumerable<PageData>> filter)
    {
    ...
    static Func<MenuItem, HelperResult> GetDefaultItemTemplate(IHtmlHelper helper) => x => new HelperResult(writer =>
                                                                                           {
    ...
    {
        readonly ViewContext _viewContext = viewContext;
        readonly bool _linked = isLinked;
        bool _disposed;
